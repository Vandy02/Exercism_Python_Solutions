...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    # Calculate the actual exchange rate with the fee included
    actual_rate = exchange_rate + (exchange_rate * (spread / 100))
    
    # Calculate total foreign currency possible
    total_new_currency = budget / actual_rate
    
    # Calculate how many full bills we can get
    number_of_bills = int(total_new_currency / denomination)
    
    # Return the maximum value of those bills
